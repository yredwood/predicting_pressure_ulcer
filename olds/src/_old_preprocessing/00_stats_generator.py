...
parser.add_argument('--fname', type=str, default='', help='any fname which has the same structure with LAB_CHART_EVENT')
...
if len(args.fname) > 0:
#    input_fname = os.path.join(data_path, args.fname)
