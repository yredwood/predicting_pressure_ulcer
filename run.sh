...
#    python src/model/pytorch-lstm.py --seed $i --exclude-feature $ex --model-type MLP --max-epoch 15  
...
# feature importance
#python src/model/pytorch-lstm.py --seed 0 --model-type MLP --max-epoch 5 --exclude-feature $ex
