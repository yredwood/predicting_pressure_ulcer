...
def main():
    ...
    for record in records:
        ...
        _refined_record = _subset_extractor(_refined_record, VITAL_SIGNS_HEADER)
        _info_record = _subset_extractor(record, INFO_HEADER)
        _lab_record = _subset_extractor(record, LAB_HEADER)
        refined_records.append({**_refined_record, **_info_record,
                                **_lab_record})

    write_csv(output_fname, INFO_HEADER + VITAL_SIGNS_HEADER \
               + LAB_HEADER, refined_records)
